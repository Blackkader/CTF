...
if __name__ == "__main__":
    tags = [
        ...
        "awel extra",
        "fully actioned",
        "https://app.securinets.io/free/palestine",
        "level7isactuallygoated", 
        "io.securinets.level7",
        "io.securinets.level7.WinHelper"
    ]
    flag = "Securinets{G00d_c4tCh_EZ_uN3xPOrTEd_4Ctivity}"
    print("[*] Flag:", flag)
